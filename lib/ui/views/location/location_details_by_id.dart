...
class LoactionDetailsScreen extends StatefulWidget {
  final int location_id;
  LoactionDetailsScreen({Key key,  this.location_id}) : super(key: key);

  @override
  _LoactionDetailsState createState() => _LoactionDetailsState();
}

class _LoactionDetailsState extends State<LoactionDetailsScreen>
 ...
 bool verticalGallery = false;
  ...
  void _showOverlay(BuildContext context , TourismLocation location) async {
                ...
                Container(
                  ...
                  child: GridView.count(
                    ...
                    children: <Widget>[
                      ...
                      InkWell(
                          onTap: () {
                            Navigator.of(context)
                                .push(CustomPageRoute(Resturants(
                              location_id: location.locationId,
                            )));
                          },
                          child: _button(
                      ...
                      InkWell(
                          onTap: () {},
                          child: _button("Reviews", FontAwesomeIcons.comment,
                              Colors.amber)),
                      InkWell(
                          onTap: () {},
                          child:
  ...
  Widget _showBottomSheet(TourismLocation location , translator) {
    if (_show) {
      return BottomSheet( 
        onClosing: () {},
        builder: (context) {
                ...
                InkWell(
                    ...
                    child: _button(
                          ...
                          translator.getCurrentLang()=="en" ?
                              ...
                              "فنادق", FontAwesomeIcons.hotel, Colors.green)),
                InkWell(
                    onTap: () {
                      Navigator.of(context)
                          .push(CustomPageRoute(Resturants(
                    ...
                    child: _button(
                        translator.getCurrentLang() == "en"
                            ? "Resturants"
                            : "مطاعم", Icons.restaurant, Colors.red)),
                InkWell(
                    onTap: () {
                    ...
                    child: _button(
                        translator.getCurrentLang() == "en"
                            ? "Reviews"
                            : "الاراء و التعليقات", FontAwesomeIcons.comment, Colors.amber)),
                InkWell(
                    onTap: () {
...
TripMap(
  ...
  location.locationEnName: location.locationArName,
                    ...
                    child: _button("Go", FontAwesomeIcons.map, Colors.blue)),
              ],
            ),
            // ElevatedButton(
            //   child: Text("Close Bottom Sheet"),
  ...
  void initState() {
    ...
    Future.microtask(()async{
          await               context.read<LocationDetailsViewModel>().getLocationDetials(widget.location_id);
  ...
  Widget build(BuildContext context) {
    ...
    return Directionality(
      ...
      child: Consumer<LocationDetailsViewModel>(
          builder: (context  , model , _){
            if(model.state==LocationDetailsState.Loading){
    
              return  LoadingWidget();
            } else if(model.state==LocationDetailsState.Error){
              return model.getErrWidget(model.exception, () async{ 


                await model.getLocationDetials(widget.location_id);
              });
            }
                model.location.locationPics.forEach((element) {
          ...
          child: Scaffold(
              body: CustomScrollView(
                slivers: <Widget>[
                  SliverAppBar(
                    ...
                    flexibleSpace: FlexibleSpaceBar(
                        ...
                        title: Text(
                          ...
                          model.location.locationEnName
                         : model.location.locationArName,
                            style: TextStyle(
                              color: Colors.white,
                              fontSize: 16.0,
                            ) //TextStyle
                        ...
                        background: Hero(
                          tag: model.location.locationId,
                          transitionOnUserGestures: true,
                          // createRectTween: (begin, end) {
                          //   return CustomRectTween(begin: begin, end: end);
                          // },
                          child: Image.network(
                            model.location.locationPics[0].pic,
                            fit: BoxFit.cover,
                          ),
                        ) //Images.network
                        ), //FlexibleSpaceBar
                    ...
                    actions: <Widget>[
                      IconButton(
                        ...
                        onPressed: () {
                          Navigator.of(context).push(CustomPageRoute(AddTrip(
                  ...
                  SliverFillRemaining(
                    child: About(model.location , translator),
                  )
                ], //<Widget>[]
              ),
              bottomSheet: _showBottomSheet(model.location  , translator)
  ...
  Widget About(TourismLocation location ,TranslationProvider translator ) {
              ...
              children: <Widget>[
                ...
                Container(
                  ...
                  child: ListView(
                    ...
                    children:location.locationPics
                        .map((e) =>
